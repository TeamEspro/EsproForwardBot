...
S = "/start"
START_PIC = "https://graph.org/file/a3ab8dd2f687c69cb2a29-533be22e528144f98a.jpg"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Haiwan](https://t.me/Ur_Haiwan)**__"  # Set caption to the title of the video
...
ESPRO_UPDATE = "https://t.me/EsproUpdate"
...
async def help_command(event):
    ...
    buttons = [[Button.url("Espro Update", url=ESPRO_UPDATE)]]
